<?php  echo form_open('form_product/insert_data');  ?>
            ...
            <div class="tab-pane <?php if($repeat_no==1){ echo 'active'; } ?>" id="tab_<?php echo $repeat_no ?>">
              ...
              <div class="row">
                ...
                <div class="col-xs-7 col-sm-7 col-md-2">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" name="product_gram_plot[]" id="product_gram_plot_<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" step="any" min="0" onchange="calculate(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-1 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" name="moisture[]" id="moisture_<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" step="any" min="0" onchange="calculate(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-1 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-2">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" name="moisture_14[]" id="moisture_14_<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" step="any" min="0" readonly="readonly" >
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-xs-7 col-sm-7 col-md-2 col-md-offset-3">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" name="product_gram_plot2[]" id="product_gram_plot2_<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" step="any" min="0" onchange="calculate(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-1 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" name="moisture2[]" id="moisture2_<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" step="any" min="0" onchange="calculate(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-1 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-2">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" name="product_kg_rai[]" id="product_kg_rai_<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" step="any" min="0" readonly="readonly" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-1 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-2">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" name="product_after_kg_rai[]" id="product_after_kg_rai_<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" step="any" min="0" readonly="readonly" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 col-hidden">
