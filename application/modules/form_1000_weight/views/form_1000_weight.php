<?php  echo form_open('form_1000_weight/insert_data');  ?>
          ...
          <div class="col-xs-12">
            ...
            <div class="row">
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="number" class="form-control" step="any" min="0"  onchange="averageBoxes(<?php echo $pedigree_selected[$i]['rp_id'] ;?>)" id="no_1<?php echo $pedigree_selected[$i]['rp_id'] ;?>" name="no_1[]">
                  </div>
                </div>
              </div>
              <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="number" class="form-control" step="any" min="0" onchange="averageBoxes(<?php echo $pedigree_selected[$i]['rp_id'] ;?>)" id="no_2<?php echo $pedigree_selected[$i]['rp_id'] ;?>" name="no_2[]">
                  </div>
                </div>
              </div>
              <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="number" class="form-control" step="any" min="0" onchange="averageBoxes(<?php echo $pedigree_selected[$i]['rp_id'] ;?>)" id="no_3<?php echo $pedigree_selected[$i]['rp_id'] ;?>" name="no_3[]">
                  </div>
                </div>
              </div>
              <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="number" class="form-control" step="any" min="0" onchange="averageBoxes(<?php echo $pedigree_selected[$i]['rp_id'] ;?>)" id="no_4<?php echo $pedigree_selected[$i]['rp_id'] ;?>" name="no_4[]">
                  </div>
                </div>
              </div>
              <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="number" class="form-control" step="any" min="0" onchange="averageBoxes(<?php echo $pedigree_selected[$i]['rp_id'] ;?>)" id="no_5<?php echo $pedigree_selected[$i]['rp_id'] ;?>" name="no_5[]">
                  </div>
                </div>
              </div>
              <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
              ...
              <div class="col-xs-7 col-sm-7 col-md-2">
                <div class="form-group">
                  <div class="input-group">
                    <input type="number" class="form-control" step="any" min="0" readonly="readonly" id="average<?php echo $pedigree_selected[$i]['rp_id'] ;?>" name="average[]">
                  </div>
                </div>
              </div>
