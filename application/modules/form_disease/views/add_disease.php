      ...
      <div class="col-md-12"> 
        ...
        <div class="box box-success">
          <div class="box-header with-border">
            ...
            <div align="right">
            <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#modalMd"><i class="fa fa-plus"></i> เพิ่มข้อมูลโรค</button>
            </div>
          </div>
              ...
              <div class="col-md-12">
                <table id="seed_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php 
				$num = 1;
                foreach($get_pest_disease as $value) { ?>
                    <tr>
                      <td><?php echo $num ?></td>
                      <td><a href="#"><?php echo $value['disease_name']; ?></a></td>
                      <td align="center"><?php if($value['disease_status']==1){
						  			echo '<span class="label label-success">Active</span>' ;
								}else{
									echo '<span class="label label-danger">Inactive</span>' ;
								}?></td>
                      <td style="width:20%" align="center">
                      <a href="<?php echo site_url('form_disease/update_disease/'.$value['disease_id'].'/'.$value['disease_status'].'/'.$research_id) ?>">
                      <i class="fa fa-refresh" aria-hidden="true"></i>
                      </a>
                      &nbsp;&nbsp;
                      <a href="<?php echo site_url('form_disease/del_disease/'.$value['disease_id'].'/'.$research_id) ?>" onclick="return confirm('ยืนยันการลบ ใช่หรือไม่ ?')">
...
<?php echo form_open('form_disease/insert_disease')?>
          ...
          <div class="form-group">
            <div class="row">
              <div class=" col-lg-2 col-md-2 col-sm-2 col-xs-2" align="right">
                <label class="control-label">ชื่อโรค : </label>
              </div>
