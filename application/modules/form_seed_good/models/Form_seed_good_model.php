...
class Form_seed_good_model extends CI_Model {
	...
	{
		$this->db->trans_start();
		$this->db->insert('form_seed_good',$input);
	...
	public function get_data($research_id,$repeat)
	{
		...
		$query = $this->db->get('form_seed_good');
		return $query->result_array(); 
	}
