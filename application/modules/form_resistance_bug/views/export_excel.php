...
header("Content-Disposition: attachment; filename=ปฏิกิริยาความต้านทานโรคและแมลง (".$resistance[0]['short_name'].").xls");
?>
    ...
    <div class="box box-danger">
      ...
      <div class="box-body table-responsive"><br>
        <table border="1">
          ...
          <th>#</th>
            <th>Designation</th>
            <th colspan="2"><?php echo $resistance[0]['short_name'] ; ?></th>
              </thead>
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $get_data[$i]['value_disease'] ;?></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
