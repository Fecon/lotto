<?php  echo form_open('form_lost_grove/update_data');  ?>
                      ...
                      <tr>
                        ...
                        <td><div class="row">
                            <div class="col-md-7 col-xs-12">
                              <input type="number" name="lost_grove[]" onchange="diffBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)"  min="0" id="lost_grove<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" class="form-control" value="<?php echo @$get_data[$repeat][$i]['lost_grove'] ;?>">
                            </div>
                          </div></td>
                        <td><div class="row">
                            <div class="col-md-7 col-xs-12">
                              <input type="number" name="mixed_breed[]" onchange="diffBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)"  min="0" id="mixed_breed<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" class="form-control" value="<?php echo @$get_data[$repeat][$i]['mixed_breed'] ;?>">
                            </div>
                          </div></td>
                        <td><div class="row">
                            <div class="col-md-7 col-xs-12">
                              <input type="number" name="balance[]"  id="balance<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" class="form-control" value="<?php echo @$get_data[$repeat][$i]['balance'] ;?>">
                            </div>
                          </div>
