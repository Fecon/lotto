            ...
            <div class="col-md-9">
              <div class="box box-primary">
                ...
                <?php 
					...
					echo form_open_multipart('form_cook/record_update' , $attribute);
				?>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <?php foreach($get_detail[0]['attachment'] as $attachment){ ?>
                    	<div class="col-md-3" align="center"><a href="<?php echo base_url('assets/files/cook/'.$attachment['file_name']) ?>" target="_blank">
                        <img src="<?php echo base_url('assets/files/cook/'.$attachment['file_name']) ?>" class="img-thumbnail">
                        </a><br /><br />
                        <a href="<?php echo site_url('form_cook/img_delete/'.$research_id.'/'.$get_detail[0]['id'].'/'.$attachment['file_id']) ?>" onclick="return confirm('ยืนยันการลบ ใช่หรือไม่ ?')">
