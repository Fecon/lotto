          ...
          <div class="col-xs-12">
            ...
            <div class="row select_disease<?php echo $get_data[$i]['id'] ;?>" align="center">
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                  <input type="text" class="form-control" name="hull_color[]" step="any" value="<?php echo $get_data[$i]['hull_color'] ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="text" class="form-control" name="off_type[]" step="any" value="<?php echo $get_data[$i]['off_type'] ?>">
                  </div>
                </div>
              </div>
              <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="number" class="form-control" name="width[]" step="any" value="<?php echo $get_data[$i]['width'] ?>">
                  </div>
                </div>
              </div>
              <div class="col-xs-5 col-sm-5 col-md-1 col-hidden">
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="number" class="form-control" name="length[]" step="any" value="<?php echo $get_data[$i]['length'] ?>">
                  </div>
                </div>
              </div>
              <div class="col-xs-5 col-sm-5 col-md-1 col-hidden">
              ...
              <div class="col-xs-7 col-sm-7 col-md-1">
                <div class="form-group">
                  <div class="input-group">
                    <input type="number" class="form-control" name="shape[]" step="any" value="<?php echo $get_data[$i]['shape'] ?>">
                  </div>
                </div>
              </div>
