...
<html lang="en">
    <head>
        ...
        <meta name="description" content="ระบบฐานข้อมูลด้านการปรับปรุงพันธุ์ข้าวนาน้ำฝน" />
        <meta name="author" content="T-tec" />
        <link rel="shortcut icon" href="<?php echo base_url('assets/dist/img/fav.png') ?>">
        <title>ระบบฐานข้อมูลด้านการปรับปรุงพันธุ์ข้าวนาน้ำฝน</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>ศูนย์วิจัยข้าว</b></span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2015 <a hreLatest Ordersf="http://almsaeedstudio.com">Almsaeed Studio</a>.</strong> All rights reserved.
      </footer>
...
<script src="d<?php echo base_url()?>assets/dist/js/demo.js"></script> 
<!-- fullCalendar 2.2.5 --> 
