<?php  echo form_open('form_grove/update_data');  ?>
            ...
            <div class="tab-pane <?php if($repeat_no==1){ echo 'active'; } ?>" id="tab_<?php echo $repeat_no ?>">
              ...
              <div class="row">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" min="0" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" id="no_1<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_1[]" value="<?php echo $get_data[$repeat][$i]['no_1'] ;?>" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" min="0" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" id="no_2<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_2[]" value="<?php echo $get_data[$repeat][$i]['no_2'] ;?>" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" min="0" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" id="no_3<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_3[]" value="<?php echo $get_data[$repeat][$i]['no_3'] ;?>" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" min="0" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" id="no_4<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_4[]" value="<?php echo $get_data[$repeat][$i]['no_4'] ;?>" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" min="0" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" id="no_5<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_5[]" value="<?php echo $get_data[$repeat][$i]['no_5'] ;?>" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
