...
<script>
	...
	function add_repair()
	{
		...
		repair_number = isNaN(repair_number) ? 0 : repair_number;
	  	...
	  	var select_repair = '.select_repair';
					  ...
					  '<div class="form-group added_repair'+ count +'">'
                      +'<div class="col-sm-1"></div>'
                      ...
                      +'<input type="hidden" name="date_id[]" value="">'
					  +'<span class="input-group-addon" onClick="remove_repair('+ count +')" style=" border-style:dashed;"><a><i class="fa fa-minus-circle" aria-hidden="true"></i></a></span> '
					 );
		repair_number++;
		document.getElementById('repair_number').value = repair_number;
	}
	function remove_repair(b)
	{
			var count = b ;
			
			var selected = '.added_repair'+ count ;
	...
	function add_fertilizer()
	{
		...
		fertilizer_number = isNaN(fertilizer_number) ? 0 : fertilizer_number;
	  	...
	  	var select_fertilizer = '.select_fertilizer';
					...
					'<div class="form-group added_fertilizer'+ count +'">'
					...
					+'  <span class="input-group-addon" onClick="remove_fertilizer('+ count +')" style=" border-style:dashed;"><a><i class="fa fa-minus-circle" aria-hidden="true"></i></a></span> '
                    +'  <input type="hidden" name="date_type[]" value="4" >'
                    +'  <input type="hidden" name="date_id[]" value="">'
                    +'</div>'
                    +'  </div>'
	...
	function remove_fertilizer(b)
	{
			var count = b ;
			
			var selected = '.added_fertilizer'+ count ;
			//var input_animal = '.input_animal' + plot_no.toString()  ;
	...
	function add_weed()
	{
		...
		weed_number = isNaN(weed_number) ? 0 : weed_number;
	  	...
	  	var select_weed = '.select_weed';
	  				...
	  				$(select_weed).append(
					'<div class="form-group added_weed'+ count +'">'
                      +'<div class="col-sm-1"></div>'
					 +'<label for="" class="col-sm-2 control-label">ครั้งที่ '+ weed_number +'  : วันที่       </label>'
					  ...
					  +'		<span class="input-group-addon" onClick="remove_weed('+ count +')" style=" border-style:dashed;"><a><i class="fa fa-minus-circle" aria-hidden="true"></i></a></span> '
	...
	function remove_weed(b)
	{
			var count = b ;
			
			var selected = '.added_weed'+ count ;
			//var input_animal = '.input_animal' + plot_no.toString()  ;
