      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
           ...
           <?php 
							$result = $this->session->flashdata('insert_research');
							 if($result=='done'){ ?>
             <div class="row">
      <div class="col-xs-10 col-xs-offset-1">              
          <div class="alert alert-success">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
            <strong>Success!</strong> เพิ่มการทดลองสำเร็จ. </div>
            </div>
            </div>
          <?php  } ?>
          <!-- /.box-header -->
                  ...
                  <table id="research_pending<?php echo $value['GEO_ID']; ?>" class="table table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="left" width="70%"><a class="block-with-text" href="<?php echo site_url('research/form_index/'.$value_research['research_id']) ?>"><?php echo $value_research['research_name'] ?></a></td>
                        ...
                        <?php if($user_data['user_role'] == 1 || $user_data['user_role'] == 2 ){ ?>
                        	<a href="<?php echo site_url('research/research_edit/'.$value_research['research_id']) ?>"><i class="fa fa-wrench"></i></a>
                        <?php }else{ ?>
							<a href="<?php echo site_url('research/form_index/'.$value_research['research_id']) ?>"><i class="fa fa-eye"></i></a>	
						<?php } ?>
                          </div></td>
                      </tr>
                      <?php } ?>
                  ...
                  <table id="research_done<?php echo $value['GEO_ID']; ?>" class="table table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><div align="center"><a href="<?php echo site_url('research/form_index/'.$value_done['research_id']) ?>"><i class="fa fa-eye"></i></a></div></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
