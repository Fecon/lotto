          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">สรุปแผนผัง</h3>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="info-box">
								...
								?>
                                ">
                                 <?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>
                                </span>
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        <tr>
                        <td align="center">
						<select class="form-control select2" name="block[]" style="min-width:60px;" required="required">
                        ...
                        <input type="hidden" class="form-control" name="ped_plot_id[]" value="<?php echo $pedigree_plot[$repeat][$i]['ped_plot_id'] ;?>"  />
                        		<select class="form-control select2" name="entry[]" style="min-width:60px;" required="required">
                                <?php if(!is_null($pedigree_plot[$repeat][$i]['entry'])){ ?>
								<option value="<?php echo $pedigree_plot[$repeat][$i]['entry'] ?>"><?php echo $pedigree_plot[$repeat][$i]['entry'] ?></option>	
								<?php } ?>
                                <?php for($j=0;$j<count($pedigree_selected);$j++){ ?>
            ...
            <?php } ?>
                  ...
                  <div class="box-footer">
                    ...
                    <button  type="submit" class="btn btn-primary"><i class="fa fa-floppy-o"></i> ยืนยัน</button>
