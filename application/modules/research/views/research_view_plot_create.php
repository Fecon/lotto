          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-info">
                <div class="box-header with-border" align="center"><br />

					<a  href="<?php echo site_url('research') ?>" ><button class="btn btn-success btn-lg"><i class="fa fa-check"></i> ยืนยันการสร้างการทดลอง </button></a><br />
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                              <div class="info-box">
								...
								?>
                                ">
                                 <a class="tooltips" href="#" style="color:#FFF"><?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>
<span><?php echo $pedigree_plot[$repeat][$i]['designation'] ;?></span></a>
                                </span>
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        <tr>
                        <td align="center">
                        <input type="text" class="form-control" name="block[]" value="<?php echo $pedigree_plot[$repeat][$i]['block'] ;?>" readonly="readonly" /></td>
                        <td align="center">
                        <input type="text" class="form-control" name="entry[]" value="<?php echo $pedigree_plot[$repeat][$i]['entry'] ?>" readonly="readonly"  />
