...
<div class="content-wrapper"> 
  ...
  <section class="content"> 
    ...
    <?php 
			...
			echo form_open('research/research_ctrl/insert_research',$attributes);
	?>
    <div class="row">
      <div class="col-md-12"> 
        <!-- Horizontal Form -->
        <div class="box box-primary">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="research_name" id="research_name" placeholder="" required onchange="add_seesion()"
            <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['research_name'].'"';
				}
			?> >
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <select class="form-control" required name="type_of_ecology" id="type_of_ecology"  onchange="add_seesion()">
                  <?php foreach($type_of_ecology as $value_toe){
					if(isset($all_session['research_temporary'])&&$all_session['research_temporary']['type_of_ecology']==$value_toe['toe_id']){
						echo '<option selected="selected" value="'.$all_session['research_temporary']['type_of_ecology'].'">'.$value_toe['toe_name'].'</option>';
					}else{
			...
			?>
              ...
              <div class="col-sm-5">
                <select class="form-control" name="type_of_research" id="type_of_research" onchange="add_seesion()" required>
                  <?php foreach($type_of_research as $value_tor){
				  		if(isset($all_session['research_temporary'])&&$all_session['research_temporary']['type_of_research']==$value_tor['tor_id']){
						echo '<option selected="selected" value="'.$all_session['research_temporary']['type_of_research'].'">'.$value_tor['tor_name'].'</option>';
					}else{
            ...
            <div class="form-group">
              ...
              <label for="" class="col-sm-2 control-label">พ.ศ.</label>
              <div class="col-sm-2">
                <input type="text" class="form-control" name="research_year" id="research_year" maxlength="4" required onchange="add_seesion()"
            <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['research_year'].'"';
				}else{
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control select2" name="dep_no[]" id="dep_no" onchange="add_seesion()"  multiple="multiple" data-placeholder="ศูนย์วิจัย" style="width: 100%;" >
                  ...
                  <?php 
					  if(isset($all_session['research_temporary'])){
							if($all_session['research_temporary']['dep_no']==$department['dep_no']){
								echo '<option selected="selected" value="'.$all_session['research_temporary']['dep_no'].'">'.$department['dep_name'].'</option>';
							}else{
								echo '<option value="'.$department['dep_no'].'">'.$department['dep_name'].'</option>';
							}
					}else{
						if($all_session['user_data']['dep_no']==$department['dep_no']){
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <div class="row">
                  <div class="col-sm-5">
                    <input type="number" min="0" class="form-control" step="any" name="plot_width" id="plot_width" placeholder=""  onchange="add_seesion()" required
                <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['plot_width'].'"';
				}
				?>  />
                  </div>
                  <label for="" class="col-sm-1 control-label">x </label>
                  <div class="col-sm-5">
                    <input type="number" min="0" class="form-control" step="any" name="plot_height" id="plot_height" placeholder=""  onchange="add_seesion()" required
                <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['plot_height'].'"';
				}
				?>  />
                  </div>
                </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="number" min="0" class="form-control" name="rows_rice" id="rows_rice" placeholder="" onchange="add_seesion()" required
            <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['rows_rice'].'"';
				}
				?> >
              </div>
              ...
              <div class="col-sm-3">
                <input type="number" min="0" class="form-control" name="rice_num" id="rice_num" placeholder="" onchange="add_seesion()" required
            <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['rice_num'].'"';
				}
				?> >
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="number" min="0" class="form-control" name="rows_distance" id="rows_distance" placeholder="" onchange="add_seesion()" required
            <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['rows_distance'].'"';
				}
				?> >
              </div>
              ...
              <div class="col-sm-3">
                <input type="number" min="0" class="form-control" name="grove_distance" id="grove_distance" placeholder="" onchange="add_seesion()" required
            <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['grove_distance'].'"';
				}
				?> >
              </div>
              <label for="" class="col-sm-1 control-label">ซม. </label>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="number" min="1" class="form-control" step="any" name="length_harvest" id="length_harvest" placeholder=""  onchange="add_seesion()" required
                <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['length_harvest'].'"';
				}
				?>  />
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="number" min="1" class="form-control" name="rows_harvest" id="rows_harvest" placeholder="" onchange="add_seesion()" required
            <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['rows_harvest'].'"';
				}
				?> >
              </div>
              <label for="" class="col-sm-1 control-label">แถว </label>
              <label for="" class="col-sm-2 control-label">แถวละ </label>
              <div class="col-sm-3">
                <input type="number" min="0" class="form-control" name="num_harvest" id="num_harvest" placeholder="" onchange="add_seesion()" required
            <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['num_harvest'].'"';
				}
				?> >
              </div>
              <label for="" class="col-sm-1 control-label">กอ</label>
                ...
                <table id="seed_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php 
                            ...
                            $num_seed = 1;
                            foreach($get_pedigree_selected as $value_selected) { ?>
                    <tr>
                      ...
                      <td style="width:15%;word-break: break-all;"><p><?php echo $value_selected['traits']; ?></p></td>
          ...
          <div class="box-body">
            <div class="row">
			  ...
			  if(isset($all_session['pedigree_selected'])){
				  echo count($all_session['pedigree_selected']);
				  } 
				  ?>" >
                </div>
              </div>
            ...
            <div class="row">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="radio">
                    <label>
                      <input type="radio" name="type_of_plan" id="type_of_plan" value="Alpha Lattice" onclick="add_seesion()" required
                  <?php 
				if(isset($all_session['research_temporary'])){
					if($all_session['research_temporary']['type_of_plan']=='Alpha Lattice'){
				...
				?> >
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label>
                      <input type="radio" name="type_of_plan" id="type_of_plan" value="RCB" onclick="add_seesion()" required
                  <?php 
				if(isset($all_session['research_temporary'])){
					if($all_session['research_temporary']['type_of_plan']=='RCB'){
						echo 'checked="checked"';
					}
				}
				?> >
            ...
            <div class="row">
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="number" min="0" class="form-control RCB" name="block_amount" id="block_amount" placeholder="" onchange="add_seesion()" required
              <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['block_amount'].'"';
				}
				?> >
                </div>
              </div>
            ...
            <div class="row">
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="number" min="0" class="form-control" name="repeat_amount" id="repeat_amount" placeholder="" onchange="add_seesion()" required
              <?php 
				if(isset($all_session['research_temporary'])){
					echo ' value="'.$all_session['research_temporary']['repeat_amount'].'"';
				}
				?> >
                </div>
              </div>
            ...
            <div class="row">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="radio">
                    <label>
                      <input type="radio" name="entry_type" id="entry_type" value="1" onclick="add_seesion()" required
                  <?php 
				if(isset($all_session['research_temporary'])){
					if($all_session['research_temporary']['entry_type']=='1'){
						echo 'checked="checked"';
					}
				}
				?> >
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label>
                      <input type="radio" name="entry_type" id="entry_type" value="3" onclick="add_seesion()" required
                  <?php 
				if(isset($all_session['research_temporary'])){
					if($all_session['research_temporary']['entry_type']=='3'){
						echo 'checked="checked"';
					}
				}
				?> >
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <label>
                      <input type="radio" name="entry_type" id="entry_type" value="2" onclick="add_seesion()" required
                  <?php 
				if(isset($all_session['research_temporary'])){
					if($all_session['research_temporary']['entry_type']=='2'){
						echo 'checked="checked"';
					}
				}
				?> >
    ...
    <div class="modal fade" id="check_pedigree" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">เลือกพันธุ์/สายพันธุ์</h4>
          </div>
          <?php 
              ...
              <table id="seed_add" class="table table-hover table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="#"><?php echo $value_pedigree['designation']; ?></a></td>
...
$(document).ready(function(){
	...
	*/  
    ...
    var url ="<?php echo site_url('research/research_ctrl/select_pedigree_temp');?>";
    ...
    $.ajax({
              ...
              success: function(rs) {
                console.log(rs);
                window.location="<?php echo site_url('research/research_create');?>";
              },
			...
			$('input[type=radio][name=type_of_plan]').click(function(){
				var related_class=$(this).val();
				$('.'+related_class).prop('readonly',true);
				
				$('input[type=radio][name=type_of_plan]').not(':checked').each(function(){
					var other_class=$(this).val();
					$('.'+other_class).prop('readonly',false);
				});
			});
		});
