...
<div class="content-wrapper"> 
  ...
  <section class="content"> 
    ...
    <?php 
				...
				echo form_open('research/research_ctrl/edit_research',$attributes);
		  ?>
    <div class="row">
      <div class="col-md-12"> 
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <select class="form-control select2" style="width: 100%;"  name="user_id" id="user_id" required >
				  ...
				  <?php if($research_detail['user_id']==$user['user_id']) {
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <div class="row">
                  <div class="col-sm-5">
                    <input type="number" min="0" class="form-control" step="any" name="length_harvest" id="length_harvest" placeholder=""  onchange="add_seesion()"
                <?php 
				if(isset($research_detail)){
				...
				?>  />
                  ...
                  <label for="" class="col-sm-1 control-label">x </label>
                  <div class="col-sm-5">
                    <input type="number" min="0" class="form-control" step="any" name="width_harvest" id="width_harvest" placeholder=""  onchange="add_seesion()"
                <?php 
				if(isset($research_detail)){
					echo ' value="'.$research_detail['width_harvest'].'"';
				}
				?>  />
                  </div>
                </div>
      ...
      <div class="col-md-12"> 
        ...
        <div class="box box-warning">
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="form-group">
                <label for="" class="col-sm-2 control-label">จำนวน Block </label>
                <div class="col-sm-2">
    ...
    <div class="modal fade" id="check_pedigree" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <?php echo form_open('research/research_ctrl/edit_pedigree_temp');?>
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12">
                <div class="box-body" ><br />
                  <div class="mailbox-messages" >
                    <table id="seed_add" class="table table-hover table-striped">
                      <thead>
                      <th style="width:10%" align="center"><span style="color:#39F;"><i class="fa fa-check-square fa-2x checkbox-toggle"></i></span></th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><input type="checkbox" name="pedigree_id[]" value="<?php echo $value_pedigree['pedigree_id']; ?>"
                        <?php 
...
<script>
	function add_seesion() {
		...
		var width_harvest = document.getElementById('width_harvest').value ;
