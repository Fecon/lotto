...
<div class="content-wrapper"> 
  ...
  <section class="content"> 
    ...
    <div class="row">
      <div class="col-md-12"> 
        <!-- Horizontal Form -->
        <div class="box box-info"> <?php echo form_open('research/research_ctrl/update_research_pedigree_plot_once') ?>
          ...
          <div class="box-body">
            <div class="row">
              <?php for($repeat=0;$repeat<count($pedigree_plot[0]);$repeat++){ ?>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <?php for($i=0;$i<count($pedigree_plot[0][$repeat]);$i++){ ?>
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="info-box"> <span class="info-box-icon 
								...
								?>
                                " style="font-size:2.5em;"> <?php echo $pedigree_plot[0][$repeat][$i]['plot_no'] ;?> </span>
                          ...
                          <tbody>
                            <tr>
                              <td align="center"><select class="form-control select2" name="block[]" style="min-width:60px;" required="required">
                                  <option value="<?php echo $pedigree_plot[0][$repeat][$i]['block'] ;?>"><?php echo $pedigree_plot[0][$repeat][$i]['block'] ;?></option>
                              ...
                              <td align="center" ><input type="hidden" name="plot_no[]"  value="<?php echo $pedigree_plot[0][$repeat][$i]['plot_no'] ;?>" >
                                <input type="hidden" name="block[]"  value="<?php echo $pedigree_plot[0][$repeat][$i]['block'] ;?>" >
                                <select class="form-control select2" style="min-width:80px;" name="entry[]" required="required">
