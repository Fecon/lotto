...
<div class="content-wrapper"> 
  ...
  <section class="content-header"> <?php echo form_open('pedigree') ?>
    ...
    <?php echo form_close() ?>
    <div class="row target" id="search_div" style="display:none;"> <?php echo form_open('pedigree') ?>
      <div class="col-md-12">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <select class="form-control" name="form_research" style="width: 100%;" required >
              ...
              <option value="1">ระดับน้ำในแปลง</option>
              <option value="2">กอหายและพันธุ์ปน</option>
              <option value="3">ศัตรูพืช</option>
              <option value="4">ใบม้วน ใบตาย</option>
              <option value="5">วันออกดอก</option>
              <option value="6">ความสูง</option>
              <option value="7">แตกกอ</option>
              <option value="8">จำนวนต้นต่อกอ</option>
              <option value="9">จำนวนต้นที่ไม่ออกรวง</option>
              <option value="10">จำนวนรวงต่อกอ</option>
              <option value="11">จำนวนเมล็ดต่อรวง</option>
              <option value="12">จำนวนเมล็ดดีต่อรวง</option>
              <option value="13">ผลผลิต</option>
            </select>
          </div>
        </div>
        <div class="col-md-1">
              ...
              <div class="col-md-12">
                ...
                foreach($get_pedigree as $value) { ?>
                    <tr>
                      ...
                      <td></td>
                      <td style="width:20%;word-break: break-all;"></td>
                      <td></td>
                    </tr>
                    <?php $num_seed++;} ?>
                  </tbody>
