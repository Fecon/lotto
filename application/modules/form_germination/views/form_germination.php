...
echo form_open('form_germination/insert_data',$arr);  
?>
        ...
        <div class="box-footer">
          <table  id="example2" class="table table-bordered table-hover"   >
            ...
            <tbody>
              <?php for($i = 1 ; $i<=$repeat ; $i++){ ?>
              <tr>
                <td><input type="number" min="0" step="any" class="form-control" placeholder=""  name="days[]" id="days<?php echo $i?>"></td>
                <td><input type="date" class="form-control" placeholder=""  name="date[]" id="date<?php echo $i?>"></td>
                <td><input type="number"  step="any" class="form-control" placeholder="" onkeyup="averageBoxes(<?php echo $i?>)" onchange="averageBoxes(<?php echo $i?>)" name="data1[]" id="data1<?php echo $i?>"></td>
                <td><input type="number"  step="any" class="form-control" placeholder=""  onkeyup="averageBoxes(<?php echo $i?>)" onchange="averageBoxes(<?php echo $i?>)"  name="data2[]" id="data2<?php echo $i?>"></td>
                <td><input type="number"  step="any" class="form-control" placeholder=""  onkeyup="averageBoxes(<?php echo $i?>)" onchange="averageBoxes(<?php echo $i?>)"  name="data3[]" id="data3<?php echo $i?>"></td>
                <td><input type="number"  step="any" class="form-control" placeholder=""  onkeyup="averageBoxes(<?php echo $i?>)" onchange="averageBoxes(<?php echo $i?>)"  name="data4[]" id="data4<?php echo $i?>"></td>
                <td><input type="number"  step="any" class="form-control" placeholder=""  onkeyup="averageBoxes(<?php echo $i?>)" onchange="averageBoxes(<?php echo $i?>)"  name="total[]" id="total<?php echo $i?>"></td>
                <td><input type="number"  step="any" class="form-control" placeholder=""  onkeyup="averageBoxes(<?php echo $i?>)" onchange="averageBoxes(<?php echo $i?>)"  name="avg[]" id="avg<?php echo $i?>">
