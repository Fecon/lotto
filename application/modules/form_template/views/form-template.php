...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <li><a  href="<?php echo site_url('research/form_index/'.$research_id) ?>" class="btn btn-social-icon btn-linkedin" style="color:#FFF; border-color:#FFF;"><i class="fa fa-th"></i></a></li>
        </ol>
        </section><br>
        <ol class="breadcrumb">
