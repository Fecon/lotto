...
echo form_open('form_germination_analyze/update_data',$arr);  
?>
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <input type="number"  step="any" class="form-control" id="" name="weight[]" placeholder="" value="<?php echo $germination_repeat[$i-1]['weight'] ?>">
          </div>
        </div>
        <?php } ?>
        <div class="row">
          ...
          <table id="seed_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><input type="number"  step="any" class="form-control" placeholder="" onkeyup="averageBoxes3(<?php echo $i?>)" onchange="averageBoxes3(<?php echo $i?>)" name="data1[]" id="data1<?php echo $i?>" value="<?php echo $germination_repeat[$i-1]['data1'] ?>"></td>
                <td><input type="number"  step="any" class="form-control" placeholder="" onkeyup="averageBoxes3(<?php echo $i?>)" onchange="averageBoxes3(<?php echo $i?>)" name="data2[]" id="data2<?php echo $i?>"  value="<?php echo $germination_repeat[$i-1]['data2'] ?>"></td>
                <td><input type="number"  step="any" class="form-control data3" placeholder=""  onkeyup="averageBoxes3(<?php echo $i?>)" onchange="averageBoxes3(<?php echo $i?>)"  name="data3[]" id="data3<?php echo $i?>"  value="<?php echo $germination_repeat[$i-1]['data3'] ?>" readonly></td>
                <td><input type="number"  step="any" class="form-control data4" placeholder=""  onkeyup="averageBoxes4(<?php echo $i?>)" onchange="averageBoxes4(<?php echo $i?>)"  name="data4[]" id="data4<?php echo $i?>" value="<?php echo $germination_repeat[$i-1]['data4'] ?>"></td>
                <td><input type="number"  step="any" class="form-control data5" placeholder=""  onkeyup="averageBoxes5(<?php echo $i?>)" onchange="averageBoxes5(<?php echo $i?>)"  name="data5[]" id="data5<?php echo $i?>" value="<?php echo $germination_repeat[$i-1]['data5'] ?>"></td>
                <td><input type="number"  step="any" class="form-control data6" placeholder=""  onkeyup="averageBoxes6(<?php echo $i?>)" onchange="averageBoxes6(<?php echo $i?>)"  name="data6[]" id="data6<?php echo $i?>" value="<?php echo $germination_repeat[$i-1]['data6'] ?>"></td>
              </tr>
              <?php } ?>
              <tr>
                <td colspan="3" align="center">เฉลี่ย</td>
                <td><input type="text" class="form-control" name="avg_data3" id="avg_data3" placeholder="" value="<?php echo $get_data[0]['avg_data3'] ?>" readonly></td>
                <td><input type="text" class="form-control" name="avg_data4" id="avg_data4" placeholder="" value="<?php echo $get_data[0]['avg_data4'] ?>" readonly></td>
                <td><input type="text" class="form-control" name="avg_data5" id="avg_data5" placeholder="" value="<?php echo $get_data[0]['avg_data5'] ?>" readonly></td>
                <td><input type="text" class="form-control" name="avg_data6" id="avg_data6" placeholder="" value="<?php echo $get_data[0]['avg_data6'] ?>" readonly></td>
              </tr>
            </tbody>
          </table>
        </div>
