<?php  echo form_open('form_no_grain/insert_data');  ?>

<div class="row">
  <div class="col-xs-12">
    <div class="box box-danger">
      <div class="box-header">
        <h3 class="box-title">จำนวนต้นที่ไม่ออกรวงต่อกอ</h3>
      </div>
      <!-- /.box-header --><br>
              ...
              <div class="row">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      id="no_1<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_1[]" placeholder="1" min="0" >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" 
                      id="no_2<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_2[]" placeholder="2" min="0"  >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" 
                      id="no_3<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_3[]" placeholder="3" min="0"  >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" 
                      id="no_4<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_4[]" placeholder="4" min="0"  >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" 
                      id="no_5<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_5[]" placeholder="5" min="0"  >
                    </div>
                  </div>
                </div>
                </div>
                ...
                <div class="col-xs-7 col-sm-7 col-md-1 col-md-offset-3">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" 
                      id="no_6<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_6[]" placeholder="6" min="0"  >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" 
                      id="no_7<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_7[]" placeholder="7" min="0"  >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" 
                      id="no_8<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_8[]" placeholder="8" min="0"  >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" 
                      id="no_9<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_9[]" placeholder="9" min="0"  >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-1">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" onchange="averageBoxes(<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>)" 
                      id="no_10<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="no_10[]" placeholder="10" min="0"  >
                    </div>
                  </div>
                </div>
                <div class="col-xs-5 col-sm-5 col-md-2 col-hidden">
                ...
                <div class="col-xs-7 col-sm-7 col-md-2">
                  <div class="form-group">
                    <div class="input-group">
                      <input type="number" class="form-control" step="any" readonly="readonly" id="average<?php echo $pedigree_plot[$repeat][$i]['plot_no'] ;?>" name="average[]" >
                    </div>
                  </div>
                </div>
