...
class Form_awn_grove_model extends CI_Model {
	...
	{
		$this->db->trans_start();
		$this->db->insert('form_awn_grove',$input);
	...
	public function get_data($research_id,$repeat)
	{
		...
		$query = $this->db->get('form_awn_grove');
		return $query->result_array(); 
	}
