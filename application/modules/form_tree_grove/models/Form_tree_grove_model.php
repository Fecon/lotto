...
class Form_tree_grove_model extends CI_Model {
	...
	{
		$this->db->trans_start();
		$this->db->insert('form_tree_grove',$input);
	...
	public function get_data($research_id,$repeat)
	{
		...
		$query = $this->db->get('form_tree_grove');
		return $query->result_array(); 
	}
